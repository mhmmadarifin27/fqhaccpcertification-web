...
export const translations: Record<Language, TranslationDictionary> = {
  id: {
    ...
    trainingCallout: {
      ...
      description1:
        "PT FOOD QUALITY CERTIFICATION menyelenggarakan program pelatihan terstruktur untuk meningkatkan kapasitas SDM industri pangan, mencakup pemahaman prinsip HACCP, sistem CPPOB/GMP, hingga sertifikasi penyusunan dokumen HACCP.",
      description2:
      ...
      topics: [
        ...
        "Pelatihan dan Sertifikasi Penyusunan Dokumen HACCP",
      ],
    },
    gallery: {
    ...
    trainingPage: {
      ...
      programs: [
        {
          id: "pengelolaan-haccp",
          code: "TR-HACCP-01",
          title: "Pengelolaan Keamanan Pangan Berbasis HACCP",
          category: "Kompetensi Utama",
          duration: "2 Hari (16 Jam Pelajaran)",
          method: "Online Webinar / Offline In-House",
          description:
            "Pelatihan komprehensif mengenai prinsip dan penerapan sistem manajemen keamanan pangan berbasis HACCP (Hazard Analysis and Critical Control Point) sesuai regulasi SNI CXC 1:1969 dan standar internasional.",
          syllabus: [
            "Prinsip Dasar & Konsep Keamanan Pangan",
            "Penerapan Good Hygiene Practices (GHP/GMP) & SSOP",
            "Identifikasi Bahaya Biologis, Kimia, dan Fisik",
            "Penetapan Titik Kendali Kritis (CCP) & Batas Kritis",
            "Prosedur Pemantauan, Tindakan Koreksi, & Verifikasi",
            "Studi Kasus Implementasi di Industri Pangan",
          ],
          benefits: [
            "Sertifikat Pelatihan Resmi Berbarcode",
            "Modul & Template Penerapan HACCP",
            "Konsultasi Interaktif Bersama Lead Auditor",
          ],
        },
        {
          id: "penyusunan-dokumen-haccp",
          code: "TR-DOC-02",
          title: "Pelatihan dan Sertifikasi Penyusunan Dokumen HACCP",
          category: "Dokumentasi & Sertifikasi",
          duration: "2 Hari (16 Jam Pelajaran)",
          method: "Online Webinar / Offline In-House",
          description:
            "Bimbingan teknis dan sertifikasi penyusunan seluruh dokumen sistem HACCP secara lengkap, mulai dari SK Tim, Deskripsi Produk, Diagram Alir, Tabel Analisis Bahaya, hingga Manual Rencana HACCP siap audit.",
          syllabus: [
            "Struktur Dokumen Sistem HACCP Standar SNI CXC 1:1969",
            "Penyusunan SK Tim HACCP & Deskripsi Produk Lengkap",
            "Pembuatan & Verifikasi Diagram Alir Proses Produksi",
            "Penyusunan Formulir Analisis Bahaya & Penentuan CCP",
            "Penyusunan HACCP Plan, SOP Monitoring, & Formulir Rekaman",
            "Praktik Audit Dokumen & Simulasi Verifikasi",
          ],
          benefits: [
            "Sertifikat Kompetensi Penyusunan Dokumen HACCP",
            "Bundel Master Template Dokumen HACCP Siap Pakai",
            "Bimbingan Langsung Review Dokumen oleh Tim Ahli",
          ],
        },
      ],
    },
  ...
  en: {
    ...
    trainingCallout: {
      ...
      description1:
        "PT FOOD QUALITY CERTIFICATION delivers structured training programs to elevate food industry human resource capacity, covering core HACCP principles, CPPOB/GMP hygiene practices, and certified HACCP document preparation.",
      description2:
      ...
      topics: [
        ...
        "HACCP Document Preparation Training & Certification",
      ],
    },
    gallery: {
    ...
    trainingPage: {
      tagline: "FOOD SAFETY COMPETENCY DEVELOPMENT CENTER",
      title: "Training & Competence Certification Programs",
      subtitle:
      ...
      programs: [
        {
          id: "pengelolaan-haccp",
          code: "TR-HACCP-01",
          title: "HACCP-Based Food Safety Management",
          category: "Core Competency",
          duration: "2 Days (16 Hours)",
          method: "Online Webinar / Offline In-House",
          description:
            "Comprehensive training on the principles and practical implementation of HACCP-based food safety management systems in accordance with SNI CXC 1:1969 and international standards.",
          syllabus: [
            "Fundamental Principles & Food Safety Concepts",
            "Implementation of Good Hygiene Practices (GHP/GMP) & SSOP",
            "Identification of Biological, Chemical, and Physical Hazards",
            "Critical Control Point (CCP) & Critical Limit Determination",
            "Monitoring Procedures, Corrective Actions, and Verification",
            "Industry Implementation Case Studies",
          ],
          benefits: [
            "Official Barcoded Training Certificate",
            "Complete Modules & HACCP Implementation Templates",
            "Interactive Consultation with Certified Lead Auditors",
          ],
        },
        {
          id: "penyusunan-dokumen-haccp",
          code: "TR-DOC-02",
          title: "HACCP Document Preparation Training & Certification",
          category: "Documentation & Certification",
          duration: "2 Days (16 Hours)",
          method: "Online Webinar / Offline In-House",
          description:
            "Technical guidance and certification on preparing comprehensive HACCP documentation, including HACCP Team setup, Product Descriptions, Flow Diagrams, Hazard Analysis Tables, and Audit-Ready HACCP Plans.",
          syllabus: [
            "HACCP Document Architecture under SNI CXC 1:1969",
            "Drafting HACCP Team Charters & Full Product Descriptions",
            "Constructing & Verifying Production Process Flow Diagrams",
            "Completing Hazard Analysis & CCP Determination Worksheets",
            "Formulating HACCP Plans, Monitoring SOPs, & Record Forms",
            "Practical Document Audit & Verification Simulations",
          ],
          benefits: [
            "Certificate of Competence in HACCP Documentation",
            "Ready-to-use Master Template HACCP Package",
            "Direct Document Review Guidance by Food Safety Experts",
          ],
        },
      ],
    },
